                        ...
                        <div className="grid-2-col" style={{ gap: '24px' }}>
                            ...
                            <div style={docBoxStyle(kycFile)}>
                                ...
                                <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '16px' }}>
                                    {kycFile ? `Selected: ${kycFile.name}` : 'Upload Aadhar, PAN, or Passport'}
                                </p>
                                <input
                                    type="file"
                                    ref={kycInputRef}
                                ...
                                <button
                                    ...
                                    style={smallButtonStyle(kycFile)}
                                >
                            ...
                            <div style={docBoxStyle(resumeFile)}>
                                ...
                                <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '16px' }}>
                                    {resumeFile ? `Selected: ${resumeFile.name}` : 'Upload your latest CV'}
                                </p>
                                <input
                                    type="file"
                                    ref={resumeInputRef}
                                ...
                                <button
                                    ...
                                    style={smallButtonStyle(resumeFile)}
                                >
