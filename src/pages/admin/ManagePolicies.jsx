...
import { leavePolicies as initialPolicies } from '../../utils/dummyData';
// We would ideally import a more structured API here, but for now we mimic the UI
                    ...
                    {policies.map((policy, index) => (
                        <div key={index} className="card-responsive" style={{ padding: '32px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', border: '1px solid #f1f5f9' }}>
                            <div className="flex-responsive" style={{ alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
                                ...
                                <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#1e293b', margin: 0, paddingRight: '60px' }}>{policy.type}</h3>
                            </div>
